...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/zeus-artemis/css/app.css') }}">
...
<body class="@if(app()->isLocal()) debug-screens @endif antialiased bg-gray-100 text-gray-800 dark:bg-black dark:text-gray-400">

<div class="container mx-auto pt-4 mb-20">
    @include($skyTheme.'.nav')
</div>
